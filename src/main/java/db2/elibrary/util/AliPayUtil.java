...
import com.alipay.easysdk.payment.facetoface.*;
...
public class AliPayUtil {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("test alipay");
        System.out.println("请输入条码：");
        Scanner scanner = new Scanner(System.in);
        String s = scanner.nextLine();
        Boolean b = payLateFee(tradeService,s);
        System.out.println();
    ...
    // 缴纳滞纳金
    public static Boolean payLateFee(AlipayTradeService service, String code){
        String outTradeNo = "tradepay" + System.currentTimeMillis()
                + (long) (Math.random() * 10000000L);
        String subject = "缴纳滞纳金";
        String totalAmount = "0.01";
        String authCode = code;
        String body = "滞纳金共计0.01元";
        String operatorId = "1";
        String storeId = "test_store_id";
        String appAuthToken = "appid";
        ...
        AlipayTradePayRequestBuilder builder = new AlipayTradePayRequestBuilder()
                ...
                .setSellerId("1").setTimeoutExpress(timeoutExpress);
